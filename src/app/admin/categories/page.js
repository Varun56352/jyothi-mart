  ...
  return (
    <div className="min-h-screen bg-gray-50 pb-16">
          ...
          <div className="flex items-center space-x-3">
            ...
            <div>
              ...
              <p className="text-xs text-gray-500">
                Manage storefront departments and product classifications
              </p>
            </div>
          </div>
          <Link href="/admin" className="text-xs font-semibold text-[#0C831F] hover:underline">
            Admin Dashboard →
          </Link>
        </div>
      </header>
      ...
      <main className="max-w-6xl mx-auto p-4">
        <div className="bg-white rounded-2xl border border-gray-200 shadow-sm overflow-hidden h-[80vh]">
